...
public class TuVungAdapter extends ArrayAdapter<T100TuVung> {
    Activity context;
    int resource;
    List objects;
    public TuVungAdapter(Activity context, int resource, List objects) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView txtvPhienAm= (TextView) row.findViewById(R.id.txtv_gridView_phienAm);
